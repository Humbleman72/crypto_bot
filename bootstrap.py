...
def main():
    ...
    #pairs = bootstrap_loggers(intervals=['1d', '7d', '30d'], 
    #                          pairs=None, download_interval='1d')
    #pairs = bootstrap_loggers(intervals=['1h', '2h', '4h', '12h'], 
    #                          pairs=pairs, download_interval='1h')
    #pairs = bootstrap_loggers(intervals=['5min', '15min', '30min'], 
    #                          pairs=pairs, download_interval='1m')
    intervals = ['1min', '5min', '15min', '30min', '1h', '2h', '4h', '12h', '1d']
    pairs = bootstrap_loggers(client=client, assets=assets, intervals=intervals, 
                              pairs=None, download_interval='1m', period=1440)
