...
then
    /opt/conda/bin/conda install --yes --channel conda-forge gcc gxx_linux-64 gcc_linux-64 cython numexpr bottleneck pandas=1.2.5 numpy scipy matplotlib tqdm setuptools-git ta-lib jupyterlab ipywidgets widgetsnbextension typeguard && \
